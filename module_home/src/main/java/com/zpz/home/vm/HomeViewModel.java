...
public class HomeViewModel extends BaseViewModel {
    ...
    public void requesIndexNotice(){
        new MyHttp().doPost(Api.getDefault().getIndexNotice(UserUtils.getToken()), new HttpListener() {
            @Override
    ...
    public void requesUserInfo(){
        new MyHttp().doPost(Api.getDefault().getUserInfo(UserUtils.getToken()), new HttpListener() {
            @Override
            public void onSuccess(JSONObject result) {
